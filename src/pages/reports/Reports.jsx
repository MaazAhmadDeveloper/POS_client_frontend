  ...
  return (
    <Layout>
      ...
      <div style={{position: "relative"}}>
        ...
        <Button className='add-new' onClick={() => setDownloadModal(true)} style={{position:"absolute", right: 10, zIndex: "1000", top: 45, height:"40px", padding:5, width:120 }} >Download <DownloadOutlined style={{marginLeft:"15px"}} /> </Button>
